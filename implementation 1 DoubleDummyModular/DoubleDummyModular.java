/* File: DoubleDummyModular.java - August 2014 */
...
public class DoubleDummyModular  {
   ...
   public static int PlayOut(ArrayList<Card> hand, ArrayList<ArrayList<Card>> opponentsHands, ArrayList<Player> playerTypes) {
   ...
   public static int PlayOut(ArrayList<Card> preHand, ArrayList<ArrayList<Card>> preOpponentsHands, State state) {
      ...
      // Call the old method if we are starting the trick
      if (state.getCurrentTrick() == null) {
         return PlayOut(hand, opponentsHands, state.getPlayerTypes());
      }
